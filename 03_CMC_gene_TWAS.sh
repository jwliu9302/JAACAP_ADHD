...
--weights /home/liujw/software/fusion/weight_files/RNA/CMC/gene/CMC.BRAIN.RNASEQ.pos.addN.add_panel \
--weights_dir /home/liujw/software/fusion/weight_files/RNA/CMC/gene \
--ref_ld_chr /home/liujw/software/fusion/LD_ref/EUR/LDREF/1000G.EUR. \
--coloc_P 0.05 \
--GWASN 225534 \
--chr ${chr} \
--out ADHD_CMC_gene.${chr}.dat
done
